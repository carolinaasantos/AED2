# Hash table com tratamento de colisões por endereçamento aberto -> Quadratic Probing
...
class HashTable:
    ...
    # Função Hash auxiliar (quadratic probing)
    ...
    # Função Hash para Quadratic Probing
    def fn_hash(self, key, i):
        c1 = 3
        c2 = 5

        # O index depende da fn. aux, do i e das constantes c1 e c2 (uma fn. quadrática)
        index = (self.fn_aux(key) + (c1 * i + c2 * (i ** 2))) % self.size
        return index
